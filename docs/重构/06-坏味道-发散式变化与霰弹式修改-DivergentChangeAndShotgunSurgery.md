...
2. 收敛成表——**第五轮未过** → 终版文件已给出；**用户选择跳过（2026-08-03，元指令）**，终版存档于本笔记「五、标准解」，可回补
3. 骨架：[Homework/重构/第一轮-最常踩的坏味道/HeroSystem.cs](Homework/重构/第一轮-最常踩的坏味道/HeroSystem.cs)

**Day 6 收官 ✅（2026-08-03）**：概念题掌握（发散=拆 / 霰弹=合；数据用表，逻辑用多态）。
